...
namespace KontrolaPakowania.API.Services.Shipment.Fedex.DTOs
{
    public class TransactionShipment
    {
        ...
        public List<ShipmentDocument> ShipmentDocuments { get; set; } // <== This is not in your sample JSON but required if present in others
    ...
    {
        // Empty in sample, but defined to avoid deserialization issues
    }
